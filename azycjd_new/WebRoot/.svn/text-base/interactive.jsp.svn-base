...
<div class="interactivemain" id="mainContent">
	...
	<div class="divTableCss">
		<div class="signTitleDiv">
		 ...
		 <c:if test="${s.state ==1}">
		 <div class="signTitleDiv" style="background-color:#f6fbfe !important">
			<div style="width: 200px;">${s.memberNickr }的回复</div>
			<div style="width: 630px;text-align: right;"><fmt:formatDate value="${s.replyTime }" pattern="yyyy-MM-dd HH:mm"/></div>
		 </div>
		 <div class="signContentDiv" style="padding-left:20px;width:95%;">
			${s.replyContent }
		 </div>
