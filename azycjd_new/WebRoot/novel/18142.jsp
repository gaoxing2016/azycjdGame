...
<html xmlns="http://www.w3.org/1999/xhtml,http://open.weibo.com/wb">
  <head>
	...
	<meta http-equiv="keywords" content="梦生传,逆天而行,温柔,道士,灵异,正剧"/>
	<meta http-equiv="description" content="梦生传,逆天而行,温柔,道士,灵异,正剧"/>
  ...
  <body id="top_banner" style="padding:0px; margin:0px; background:url(${sessionShouyetoubu})  center 0px no-repeat #f0f0f0;">
	...
	<div class="main_css">
		...
		<div style="position:absolute; top:720px; margin-left:70px;">
			<img src="/attached/image/20160620/20160620152926_16.jpg" width="375" height="500" />
		</div>
		...
		<div style="position:absolute; top:1120px; margin-left:745px;">
			<div class="self_btn" style="margin-left:50px;margin-top:15px;"><a href="<%=request.getContextPath()%>/novel/18142/index.jsp">立刻阅读</a></div>
		</div>		
			...
			<div class="projects_head">
				<div class="head_youshang">
					...
					<div class="head_hang" style="margin-top:25px;">
						<div style="font-size:40px;font-weight: bolder;font-family:'黑体';">梦生传</div>
					</div>
					...
					<div class="youshang_second" id="zuopin">
						...
						<!-- <div class="head_hang" style="clear:both;padding-top:7px;">
							<div>作者：</div>
							<div class="author_name" onclick="javascript:window.open('<%=request.getContextPath()%>/anzhiauthor/findAnzhiAuthorByDetail.do?anzhiauthorId=47274')">杨梦生</div>
						</div> -->
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>小说作者：</div>
							<div style='cursor: pointer;font-weight: bold;' onclick="javascript:window.open('<%=request.getContextPath()%>/anzhiauthor/findAnzhiAuthorByDetail.do?anzhiauthorId=47274')">杨梦生</div>
						</div>
						...
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>周点击：</div>
							<div id="zhoudianji">27</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>周推荐：</div>
							<div id="zhoutuijian"></div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>月点击：</div>
							<div id="yuedianji">58</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>月推荐：</div>
							<div id="yuetuijian"></div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>月票：</div>
							<div id="yuetuijian"></div>
						...
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>总点击：</div>
							<div id="zongdianji">58</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>总字数：</div>
							<div id="zongzishu">16947</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>更新时间：</div>
							<div id="gengxinshijian">2016-06-28 09:17:17</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>是否签约：</div>
				...
				<div>
					<div class="head_zuoxia">
						<div class="zuoxia_hang">
							...
							<div id="shoucangbenshu" style="display: none;"><a href="javascript:;" onclick="multifunction(this,'${loginUsers.id}','18142',1,'梦生传')">收藏本书</a></div>
						...
						<div id="da_shang_button" class="zuoxia_hang">
							<div class="tuijian_div" onclick="daShangNovel(0,'${loginUsers.id}','18142','梦生传')"></div>
							<div class="yuepiao_div" onclick="daShangNovel(1,'${loginUsers.id}','18142','梦生传')"></div>
							<div class="cuigeng_div" onclick="daShangNovel(2,'${loginUsers.id}','18142','梦生传')"></div>
							<div class="dashang_div" onclick="daShangNovel(3,'${loginUsers.id}','18142','梦生传')"></div>
						</div>
					</div>
					<div class="head_youxia">
						<div style="min-height:90px;height:auto;" class="xiaoshuojieshao">
							<div id='novel_jieshao'>　  刑雷聚阳身 
    万鬼皆服臣 
    不入轮回苦 
    己身空枉渡 
    何为道、道乃本心世间善恶皆有定数 
    何为道、道乃自然逆天不悔难入轮回<span class='moreJieShao' onclick='moreJieShao(18142)'>展开</span></div>
						</div>
						<div class="youxia_er">
							<div>标签:逆天而行,温柔,道士,灵异,正剧</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="projects_mafan">
				...
				<div style="width:290px;height:280px;" id="fensibang">
					...
					<div style="margin-top: 10px; padding-bottom:30px; font-size: 12px;"><a href="javascript:window.open('<%=path %>/anzhinovel/moreFenSi.do?novelId=18142')">更多...</a></div>
				</div>
		    ...
		    <div class="shupingqu">
		    	<div class="shupingqu_two">
		    		<div class="shupingqu_title">梦生传书评区<span class="look_more_comment" onclick="window.open('<%=request.getContextPath() %>/anzhicomment/findMyAnzhiCommentAllIndex.do?novelId=18142')">更多评论</span><span id="commentLiuYanTotalNum" class="commentTotal">总共0条</span></div>
			    	<!-- <div>
		    ...
		    <div class="read_pl_more">
		    	<div class="look_more_comment" onclick="window.open('<%=request.getContextPath() %>/anzhicomment/findMyAnzhiCommentAllIndex.do?novelId=18142')">查看更多评论...</div>
								...
								<div style="background-color:#FFFFFF; width:100%; border-radius:5px; padding-top:10px;">
									<div style=" margin:0 auto;width:95%;">
										...
										<div class="shupin_css_foot" style="overflow:auto; padding-top:10px; padding-bottom:10px;">
											...
											<div class="addCommentDiv" onclick="saveComment(this,18142,'${loginUsers.id}',0,0)">提交书评</div>
										</div>
