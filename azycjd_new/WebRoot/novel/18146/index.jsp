...
<html xmlns="http://www.w3.org/1999/xhtml,http://open.weibo.com/wb">
  <head>
    ...
    <title>盛世宠妃之春梦无痕</title>
	<meta http-equiv="pragma" content="no-cache"/>
	<meta http-equiv="cache-control" content="no-cache"/>
	<meta http-equiv="expires" content="0"/>    
	<meta http-equiv="keywords" content="盛世宠妃之春梦无痕,novel_pojo.guanjianci"/>
		...
		$(function(){
			...
			$.post(path+"/anzhichaptersubscribe/getDingYueChapter.do",{novelId:novelId},function(res){
				...
				if(tjson.youhuiInfo=="yes"){
					...
					$("#autoBuyDiv").html("本书有["+tjson.discountedTypeName+"]优惠，截止:"+tjson.discountedEndDate+"  <span class='discountedRebate_class'>"+tjson.discountedRebate+"</span><br/>");
	...
	<div class="main_css">
		...
		<div class="projects_main">
			<div class="title_book">
				<div class="title_book_one" onclick="window.location.href='<%=request.getContextPath()%>/novel/18146.jsp'" style="cursor: pointer;">盛世宠妃之春梦无痕</div>
				<div style="margin-top: 7px;">作者：<font class="tipsdex">羽罚奇异</font></div>
				<div>
					<span >分类:<font class="tipsdex">古代言情</font></span>
					<span style="margin-left: 40px;">章节数:<font class="tipsdex">2章</font></span>
					<span style="margin-left: 40px;">最新更新时间:<font class="tipsdex">2016-06-23 14:47:42</font></span>
			...
			<div class="projects_liebiaoone">
				<div class='fen_juan_items'><div class='fen_juan_name'>第1卷 正文内容<span class='buyFenJuan'><a href='javascript:;' onclick="buyFenJuan('18345','1','0','0')">整卷购买</a></span></div><div class='chapter_div' id='chapter_div18345'><div id='chapter410133' class='free_chapter' title="字数：1157;更新时间：2016-06-26 "><a href='javascript:;' id='1157@410133' onclick="readNovel('410133',this,'1157',1)" target="_blank">第1章 1.  慕容大小姐</a></div></div></div>	
			</div>
		</div>
	</div>
	<div class="foot_css">
