		...
		<div class="tableCss">
			<table width="100%" border="0">
				...
				<c:forEach items="${anzhicooperationList.list}" var="s" varStatus="ind">
					<tr>
						<td>${ind.index+1 }</td>
						<td><a onclick="window.open('${s.cooperationUrl }')" style="cursor:pointer;">${s.cooperationUnit }</a></td>
						<td><a onclick="window.open('${s.cooperationUrl }')" style="cursor:pointer;">${s.cooperationUrl }</a></td>
						<td>
