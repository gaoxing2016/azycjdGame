...
<div class="divInit">
	...
	<form id="AnzhiInteractiveFormAction" action="<%=request.getContextPath()%>/anzhiinteractive/addAnzhiInteractives.do" method="post">
		<div class="inputItemsCssss">
			...
			<div class="textItem">
				<font class='textTitleCss'>回复主题：</font>
				<input type="text" class="txt" name="replyTitle" id="replyTitle" value="${pojo.replyTitle}" alt=""/>
				&nbsp;&nbsp;&nbsp;*<font class='textTipsCss'>请填写回复主题</font>
			</div>
			<div class="textItem">
				<font class='textTitleCss'>回复内容：</font>
				<textarea class="htmlEditCss" style="height:230px; width: 90%;" id="replyContent" name="replyContent">${pojo.replyContent }</textarea>
			</div>
			<div class="textItem">
				<input class="saveBtnCss" type="button" value="回复" onClick="ajaxSubmit('AnzhiInteractiveFormAction',this)"/>
