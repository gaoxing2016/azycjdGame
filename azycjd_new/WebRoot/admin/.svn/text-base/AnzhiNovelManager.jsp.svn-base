	...
	<form id="AnzhiNovelForm" action="anzhinovel/findAnzhiNovelAll.do" method="post">
		<div class="searchItemsCssss">
			<div class='searchDivItemText'>
				小说编号：<input class="inputTextCss" type="text" id="id" name="id" class="txt" value="${param.id}"/>
			</div>
			<div class='searchDivItemText'>
			...
			<div style="clear: both; width:80%;">
				...
				<!-- <input class="saveBtnCss" type="button" value="更新章节记录" onclick="updateChapterRecord(this)" style="width:120px;"/> -->
			</div>
		</div>
		<div class="tableCss">
