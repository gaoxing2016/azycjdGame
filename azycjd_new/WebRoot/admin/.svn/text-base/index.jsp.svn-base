...
<html>
  <head>
	...
	<script language="javascript">var loadFirst="${anzhichapterAction}${thirdRecommand}${webEditorInfoAction}${cooperationn}${pictureAction}${newsAction}${AnzhiWebEditorWorkAction}${AnzhiWebEditorAction}${AnzhiWebEditorGoodsAction}${webEditorInfo}${novelAction}";</script>
    	...
    	<div style="background-color:#333333; height:100px;">
			<div class="main_div">
				...
				<div class="admin_top_right" style="float:right;padding-top:25px;">
					...
					<div style="background:url(admin/images/Free_Gear.png) no-repeat 5px 7px; padding-left:40px;cursor: pointer;" onClick="javascript:outAnZhiSystem()">退出系统</div>
				</div>
			</div>
		</div>
						  ...
						  <tr>
							...
							<td valign="top" width="880">
								...
								<div id="mainContent" style="padding: 10px; clear: both;">
									...
									<c:if test="${not empty anzhichapterAction }">
										<jsp:include page="AnzhiChapterAction.jsp"></jsp:include>
										<c:remove var="anzhichapterAction"/>
										<script language="javascript">
											$(function(){
