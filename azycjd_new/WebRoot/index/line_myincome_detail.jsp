...
<form class="formCss" id="incomedetailform" action="anzhiconsume/findAnzhiConsumeMyDetail.do?pageName=index/line_myincome_detail&&linenumber=14&&index=7&&chooseIndex=1" method="post">
	<div class="divTableCss">
		<table class="tableCss" width="100%" border="0">
		  <tr height="70">
			<td>开始:
				<input type="text" style="background-color: #fff;width:120px;" class="txtCss" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="begTimes" name="begTimes" value="${param.begTimes }">
			</td>
			<td>结束:
				<input type="text" style="background-color: #fff;width:120px;" class="txtCss" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="endTimes" name="endTimes" value="${param.endTimes }">
			</td>
			
			<td>查询条件:
				<input type="text" style="width:130px;background-color: #fff;" class="selectTxtCss" id="consumeTypeInput" name="consumeTypeInput" value="${param.consumeType }">
			</td>
			<td>
