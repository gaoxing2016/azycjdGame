				...
				<td width="22%" style="background-color:#e3e3e3;height:2100px; padding-top:25px;" valign="top">
					...
					<div class="right_menu_div">
						<div class="right_menu_one" <c:if test="${indexMenu eq 'zuozhe'}">style="display: none;"</c:if>>
							...
							<hr class="xiahuxai" />
							<ul>
								<li id="anzhitrend/findAnzhiTrendMySelf.do#linenumber=0#index=2#chooseIndex=0">个人主页<c:if test="${not empty friendNum }"><span style='padding-left: ${friendNum>10?4:7}px;' class='need_do_nums_class'>${friendNum }</span></c:if></li>
						...
						<div class="right_menu_one" <c:if test="${indexMenu eq 'duzhe' || empty indexMenu}">style="display: none;"</c:if>>
							...
							<ul style="display: block;">
								...
								<li id="anzhicash/findAnzhiCashMySelf.do#linenumber=15#chooseIndex=0" style="display: none">提现管理</li>
							</ul>
