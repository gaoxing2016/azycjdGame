	...
	<div class="divTableCss" style="min-height: 300px; padding: 15px;">
	  ...
	  <c:forEach items="${anzhifenjuanList.list }" var="s" varStatus="ind">
	  	<div class="fenjuan_items">
	  		<div class="fenjuanTitle" onclick="showDivFn('div${s.id }')">${10*(anzhifenjuanList.num-1)+ind.index+1}分卷：${s.juanName } <span style="padding-left: 15px;">[<a href="javascript:delFenJuan(${s.id })">删除分卷</a>]</span></div>
