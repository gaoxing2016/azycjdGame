...
<jsp:include page="m_head.jsp"></jsp:include>
	...
	<div style="text-align:center; margin-top:20px; height:60px; line-height:60px;cursor: pointer;" onclick="window.location.href='http://www.azycjd.com/mobile_direc.jsp'">
