			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" height="60">
			  <tr>
				<td width="20%" style="background-color: #bfbfbf;">
					<div style="margin-top:0px;" onclick="window.location.href='<%=request.getContextPath()%>/mobile/readChapter.do?chapterId=${pojo.id }&&looktype=up&&novelId=${pojo.novelId }'"><img src="<%=request.getContextPath() %>/mobile/images/shangyizhang.png" style="width:43px;"/></div>
				</td>
				<td width="20%">
				...
				<td width="20%" style="background-color: #bfbfbf;">
					<div style="margin-top:0px;" onclick="window.location.href='<%=request.getContextPath()%>/mobile/readChapter.do?chapterId=${pojo.id }&&looktype=next&&novelId=${pojo.novelId }'"><img src="<%=request.getContextPath() %>/mobile/images/xiayizhang.png" style="width:43px;"/></div>
				</td>
			  </tr>
			</table>
		</div>
