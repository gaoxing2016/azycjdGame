...
public class AnzhiInteractiveServiceImpl extends ActionDb  implements IAnzhiInteractiveService {
	...
	public boolean updateAnzhiInteractive(AnzhiInteractive anzhiinteractive,int loginmemberid){
		List<Pojo> pojoList=new ArrayList<Pojo>();
		anzhiinteractive.setReplyTime(this.getNowTime());
		anzhiinteractive.setState(1);
		anzhiinteractive.setReplyMemberId(loginmemberid);
