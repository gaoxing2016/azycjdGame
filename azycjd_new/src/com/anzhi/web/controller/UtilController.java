...
public class UtilController  extends GetCondition{
	...
	@RequestMapping(value="/util/updateChapterUpdRecord")
	public void updateChapterUpdRecord(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String mess=utilService.updateChapterUpdRecord();
		response.setCharacterEncoding("utf-8");
		response.getWriter().write(mess);
	}
	@RequestMapping(value="/util/updateNovelDingYueNum")
	public void updateNovelDingYueNum(HttpServletRequest request,HttpServletResponse response) throws IOException{
		utilService.updateNovelDingYueNum(); 
	}
}
