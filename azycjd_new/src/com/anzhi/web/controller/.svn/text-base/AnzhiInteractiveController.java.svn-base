			...
			try{
				...
				if(us==null){
					...
					if(anzhiinteractive.getId()==null||anzhiinteractive.getId()==0){
						...
						anzhiinteractive.setIsjiajing(0);
						anzhiinteractive.setIstop(0);
						anzhiinteractiveService.addAnzhiInteractive(anzhiinteractive);
					}else{
						anzhiinteractiveService.updateAnzhiInteractive(anzhiinteractive,this.getLoginMemberId(request));
					}
				}
