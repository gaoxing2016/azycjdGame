...
public class AnzhiInteractive extends FatherPojo implements java.io.Serializable {
	...
	public AnzhiInteractive setValues(Object[] obj) {
		...
		model.setIsjiajing(obj[11]==null?0:Integer.parseInt(obj[11].toString()));
		model.setIstop(obj[12]==null?0:Integer.parseInt(obj[12].toString()));
		model.setMemberNick(obj[13]==null?"":obj[13].toString());
		model.setMemberNickr(obj[14]==null?"":obj[14].toString());
		return model;
	}
	private Integer id;
	...
	private String memberNickr;
	public String getMemberNickr() {
		return memberNickr;
	}
	public void setMemberNickr(String memberNickr) {
		this.memberNickr = memberNickr;
	}
	
	private int isjiajing;
	private int istop;
	public int getIsjiajing() {
		return isjiajing;
	}
	public void setIsjiajing(int isjiajing) {
