...
public class AnzhiHandle extends FatherPojo implements java.io.Serializable {
	...
	public AnzhiHandle setValues(Object[] obj) {
		...
		model.setDaiqianyue(obj[10]==null?0:Integer.parseInt(obj[10].toString()));
		return model;
	}
	...
	private Integer daiqianyue;
	
	public Integer getDaiqianyue() {
		return daiqianyue;
	}
	public void setDaiqianyue(Integer daiqianyue) {
		this.daiqianyue = daiqianyue;
	}
